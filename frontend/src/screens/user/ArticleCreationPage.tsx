...
import { createArticle, clearArticleState } from "../../slices/articleSlice";
...
const ArticleCreationPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      dispatch(createArticle(articleFormData));
    }
  };
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        {success && (
          <Alert severity="success" sx={{ mb: 2 }}>
            Article created successfully! Redirecting to your articles...
          </Alert>
        )}
            ...
            <Grid item xs={12}>
              <Box sx={{ mb: 2 }}>
                ...
                <Button
                  ...
                  disabled={formData.images.length >= MAX_IMAGES || loading}
                >
                  Upload Images
                  <input
                    type="file"
